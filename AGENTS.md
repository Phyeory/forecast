...
>
> **iter61 Regime participation floor (user risk-policy knob; NOW PRODUCTION default 0.25 by explicit user decision 2026-08-23) — PnL gate rejects every floor in-sample; the floor is an allocation decision, not a statistically-gated alpha.**
