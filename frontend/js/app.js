...
let engineParams = {
  ...
  signal_strong: 1.73, signal_weak: 0.96, signal_noise: 1,
  exhaustion_bars_limit: 3, delta_threshold: 0.3, kalman_gamma: 0.103,
  min_trend_bars: 4, reversal_confirm_bars: 2, chop_atr_pct: 10,
  chop_spread_pct: 1, reversal_exit_confirm_bars: 1,
  s_effective_threshold: 0.5, exhaustion_persist_bars: 4,
  regime_lookback: 5, persistence_threshold: 2, momentum_mean_threshold: 0.0,
  ema_min_spread_pct: 0.02, confidence_high: 0.79, confidence_low: 0.44,
  ...
  overextension_k: 0.072,
  momentum_peak_bars: 2,
  consolidation_range_pct: 1.5,
  confidence_very_high: 0.833,
  ema_macro_period: 7,
};
