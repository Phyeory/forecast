...
let engineParams = {
  ...
  s_effective_threshold: 0.35, exhaustion_persist_bars: 5,
  regime_lookback: 5, persistence_threshold: 2, momentum_mean_threshold: 0.0,
  ema_min_spread_pct: 0.02, confidence_high: 0.785, confidence_low: 0.45571428571428574,
  ...
  local_range_bars: 13, local_range_threshold_pct: 0.7, sign_flip_threshold: 2,
  stability_bars: 5,
  ...
  consolidation_range_pct: 1.7,
  confidence_very_high: 0.8448571428571429,
  ema_macro_period: 5,
};
